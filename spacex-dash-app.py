...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL': 
        ...
        title=f'Outcome of launches in {entered_site}', color='Outcome', 
...
def get_payload_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig2 = px.scatter(data_frame= payload_range_df, 
            ...
            title='Succes v/s Payload for All Sites', 
        ...
        fig2 = px.scatter(data_frame= specific_data2, 
            x= 'Payload Mass (kg)', y= 'class', 
            color= "Booster Version Category", 
            title= f'Succes v/s Payload for {entered_site}', 
            hover_data=['Launch Site'])
        return fig2
